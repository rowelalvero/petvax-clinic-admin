...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $trainer->givePermissionTo(['view_traning', 'view_training_booking', 'view_review', 'view_owners', "view_owner's_pet", 'view_service', 'view_training_type', 'add_training_type', 'edit_training_type', 'delete_training_type']);
        $day_taker->givePermissionTo(['view_daycare', 'view_daycare_booking', 'view_review', 'view_owners', "view_owner's_pet"]);
        $petstore->givePermissionTo(['view_product', 'view_brand', 'view_unit', 'view_tag', 'view_product_variation', 'add_product', 'edit_product', 'delete_product', 'add_product_category', 'edit_product_category', 'delete_product_category', 'add_product_subcategory', 'edit_product_subcategory', 'delete_product_subcategory', 'add_unit', 'edit_unit', 'delete_unit', 'add_tag', 'edit_tag', 'delete_tag', 'add_brand', 'edit_brand', 'delete_brand', 'add_product_variation', 'edit_product_variation', 'delete_product_variation', 'add_supply', 'edit_supply', 'delete_supply', 'add_logistics', 'edit_logistics', 'delete_logistics', 'add_shipping_zones', 'edit_shipping_zones', 'delete_shipping_zones', 'view_order', 'add_order', 'edit_order', 'delete_order', 'view_order_review']);

        $petsitter->givePermissionTo(['view_pet_sitter','add_pet_sitter','edit_pet_sitter','delete_pet_sitter','view_review','view_owners',"view_owner's_pet"]);
