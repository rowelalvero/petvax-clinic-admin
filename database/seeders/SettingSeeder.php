    ...
    public function run()
    {
        ...
        $modules = [
            ...
            [
                ...
                'val' => 'https://play.google.com/store/apps/details?id=com.petvax.customer',
                'type' =>'is_application_link', 
            ],
            [
                'name' => 'customer_app_app_store',
                'val' => 'https://apps.apple.com/in/app/petvax/id6458044939',
                'type' =>'is_application_link', 
            ],
            [
                'name' => 'employee_app_play_store',
                'val' => 'https://play.google.com/store/apps/details?id=com.petvax.employee',
                'type' =>'is_application_link', 
            ],
            [
                'name' => 'employee_app_app_store',
                'val' => 'https://apps.apple.com/us/app/petvax-for-employee/id6462849036',
                'type' =>'is_application_link', 
            ],
            [
                'name' => 'is_zoom',
