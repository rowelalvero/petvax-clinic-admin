...
class SettingController extends Controller
{
    public function appConfiguraton(Request $request)
    {
        ...
        $response['google_login_status'] = 0;
        $response['apple_login_status'] = 0;
        $response['otp_login_status'] = 0;
        if (isset($settings['social_login']) && $settings['social_login'] == 1) {
            $response['google_login_status'] = isset($settings['google_login']) ? intval($settings['google_login']) : 0;
            $response['apple_login_status'] = isset($settings['apple_login']) ? intval($settings['apple_login']) : 0;
            $response['otp_login_status'] = isset($settings['otp_login']) ? intval($settings['otp_login']) : 0;
        }
