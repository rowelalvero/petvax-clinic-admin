...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_category')
                        <button type="button" title="{{ __('Create') }} Category"
    ...
    <div data-render="app">
        <form-offcanvas default-image="{{ default_feature_image() }}"
            create-title="{{ __('messages.create') }} {{ __('messages.new') }} {{ __('category.lbl_category') }}"
            edit-title="{{ __('messages.edit') }} {{ __('category.lbl_category') }} "
