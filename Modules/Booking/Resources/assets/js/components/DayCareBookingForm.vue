          ...
          <div v-if="selectedCustomer">
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Select DayCare Taker" v-bind="SingleSelectOption" @select="checkTotalAmount" :options="daycare_taker_list.options" class="form-group"></Multiselect>
