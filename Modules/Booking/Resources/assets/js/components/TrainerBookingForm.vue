        ...
        <div class="offcanvas-body border-top">
          ...
          <div v-if="selectedCustomer">
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Select trainer" @select="getTrainingList" v-bind="SingleSelectOption" :options="trainer_list.options" class="form-group"></Multiselect>
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="training" v-model="training" :value="training" placeholder="Select training" @select="getDurationList" v-bind="SingleSelectOption" :options="training_list.options" class="form-group"></Multiselect>
