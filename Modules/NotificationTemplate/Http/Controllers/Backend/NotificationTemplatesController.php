    ...
    public function index_data(Datatables $datatable)
    {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('label', function ($row) {
                return '<a href="'.route('backend.notification-templates.edit', $row->id).'">'.$row->label.'</a>';
            })
        ...
        if ($check !== null) {
            ...
            $data->defaultNotificationTemplateMap()->create(
                array_merge(
                    ...
                    [
                        'mail_subject' => $request->defaultNotificationTemplateMap['mail_subject'],
                        'mail_template_detail' => $request->defaultNotificationTemplateMap['mail_template_detail']
                    ]
                )
            );
