      ...
      <div class="offcanvas-body">
        <div class="row">
          ...
          <div class="col-md-6 form-group">
            ...
            <Multiselect id="branch_id" v-model="branch_id" :value="branch_id" placeholder="Select pet care center" v-bind="singleSelectOption" :options="branch.options" @select="branchSelect" class="form-group"> </Multiselect>
