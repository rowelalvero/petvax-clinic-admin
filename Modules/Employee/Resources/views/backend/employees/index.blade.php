...
@if($type !='')
    <employee-offcanvas type="{{ __($type) }}"  default-image="{{ default_user_avatar() }}" create-title="{{ __('messages.create') }} {{ __($create_title) }}" edit-title="{{ __('messages.edit') }} {{ __($create_title) }}" :customefield="{{ json_encode($customefield) }}">
    </employee-offcanvas>
    @else
    <employee-offcanvas type="{{ __('staff') }}"  default-image="{{ default_user_avatar() }}" create-title="{{ __('messages.create') }} {{ __($create_title) }}" edit-title="{{ __('messages.edit') }} {{ __($create_title) }}" :customefield="{{ json_encode($customefield) }}">
    </employee-offcanvas>
    @endif
