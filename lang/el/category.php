...
return [
    ...
    'lbl_category_name' => 'Υποκατηγορίας',
    ...
    'category_delete' => 'Η Κατηγορία διαγράφηκε με επιτυχία',
    'category_update' => 'Η Κατηγορία ενημερώθηκε με επιτυχία',
    'category_create' => 'Η Κατηγορία δημιουργήθηκε με επιτυχία',
