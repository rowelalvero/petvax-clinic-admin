<template>
  <form @submit="formSubmit">
    ...
    <div class="row row-cols-2">
      ...
      <InputField class="col" :is-required="true" :label="$t('setting_mail_page.lbl_from_name')" placeholder="petvax" v-model="from_name" :error-message="errors.from_name"></InputField>
    </div>
